<section class="cs_hero cs_style_3 cs_filled_bg cs_center text-center" data-src="/assets/website/assets/img/bg/hero_bg_5.svg" style="background-image: url('/assets/website/assets/img/bg/hero_bg_5.svg');">
    <div class="container">
