                ...
                <div class="cs_about cs_style_1 cs_type_1">
                    ...
                    <ul class="cs_mp_0 cs_about_summary_list">
                        ...
                        <li>
                            ...
                            <h5 class="cs_font_20 m-0 cs_semi_bold">Traveling, Cricket, Football, Design,
...
<section class="cs_100_bg position-relative" data-src="/assets/website/assets/img/bg/ed_and_skill_bg.png" style="background-image: url(&quot;assets/website/assets/img/bg/ed_and_skill_bg.png&quot;);">
        ...
        <div>
            <div class="d-lg-flex justify-content-between">
                <div class="cs_section_heading cs_style_1">
                    <h2 class="cs_section_title cs_font_48 cs_semi_bold wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">I'm great in what I do<br> and <span class="cs_accent_color">I'm
                            loving it</span>
                    </h2>
                </div>
                <div class="align-self-end">
                    <div class="cs_height_25 cs_height_lg_25"></div>
                    <a class="cs_portfolio_text_btn d-inline-flex cs_gap_25 align-items-center cs_font_24 cs_accent_color cs_semi_bold" href="contact.html">
                        ...
                        <span class="cs_circle_btn cs_style_1 cs_accent_color cs_center rounded-circle">
                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 14L14 1" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M1 1H14V14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 14L14 1" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M1 1H14V14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            ...
            <div class="col-lg-6">
                <div class="cs_education_wrap">
                    ...
                    <div class="cs_iconbox cs_style_3 cs_type_1 d-flex align-items-center">
                        ...
                        <div class="cs_iconbox_info">
                            <p class="cs_iconbox_text mb-0">Harvard University</p>
                            <h3 class="cs_iconbox_title cs_font_24 cs_semi_bold mb-0">B.Sc in CSE(2010 - 2014)
                            </h3>
                        </div>
                    </div>
                    <div class="cs_iconbox cs_style_3 cs_type_1 d-flex align-items-center">
                ...
                <div class="cs_section_heading cs_style_1">
                    <p class="cs_section_subtitle cs_accent_color_2 cs_font_16 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        ...
                        <svg width="23" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3.97591 14.5618C-0.971171 8.81681 -0.577793 3.06974 4.89025 1.37857C6.56088 0.858827 8.75716 1.23766 10.0143 2.25224L10.659 2.77411L11.539 2.18776C16.6218 -1.25827 23.3933 4.25223 20.9381 9.82952C18.7034 14.9013 10.8697 20.637 9.09113 18.5076C8.56387 17.8715 8.8053 17.7662 10.1306 18.0209C11.3936 18.2634 16.8827 12.8513 18.1731 10.0825C19.7277 6.75962 19.2971 5.02257 16.4256 2.95039C15.2389 2.1019 13.4897 2.59489 12.1834 4.176C11.1518 5.40313 10.0176 5.5552 9.00115 4.12668C6.12036 0.110156 1.92139 3.63334 3.44169 8.7862C4.07799 10.9138 4.70403 11.9614 7.02448 14.7108C8.60384 16.5728 8.65482 16.6628 8.17596 16.9503C7.26361 17.5074 5.75209 16.6451 3.97591 14.5618Z" fill="#342EAD"></path>
                            <path d="M14.9467 5.0654C14.1851 4.96639 14.7719 4.08671 15.4928 4.29588C16.0891 4.48073 16.9235 4.79201 17.2943 5.68325C17.6984 6.61905 17.0386 7.57974 16.6328 7.49297C16.2739 7.41916 16.1452 7.02459 16.1486 6.20635C16.1521 5.3881 15.7082 5.1644 14.9467 5.0654Z" fill="#342EAD"></path>
                            <path d="M16.9264 9.85448C15.938 10.1378 15.1442 9.42309 15.564 8.89173C15.8833 8.50455 17.1593 8.40681 17.5481 8.75687C17.8729 9.06399 17.7018 9.62863 16.9264 9.85448Z" fill="#342EAD"></path>
                        </svg>
                ...
                <div>
                    ...
                    <div class="cs_tab_body">
                        ...
                        <div class="cs_tab" data-id="moments">
                            <p class="m-0">Lorem ipsum dolor sit amet, <span class="cs_accent_color">consectetuer adipiscing elit</span>. Cum sociis
                                natoque penatibus et magnis dis parturient montes,<span class="cs_accent_color">
                                    nascetur ridiculus</span> mus. Donec quam felis, ultricies nec, <span class="cs_accent_color_2">pellentesque eu</span>, pretium quis, sem. Nulla
