...
@section('contents')
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="cs_image_box cs_radius_20 overflow-hidden">
                        <img class="w-100" src="/cache/assets/website/assets/img/hero_img.png" alt="">
                    </div>
                    ...
                    <div class="cs_about cs_style_1 cs_type_1">
                        ...
                        <ul class="cs_mp_0 cs_about_summary_list">
                            ...
                            <li>
                                ...
                                <h5 class="cs_font_20 m-0 cs_semi_bold">BSC in Computer Science &amp; Engineering</h5>
                            </li>
                            <li>
    ...
    <section class="cs_100_bg position-relative" data-src="/cache/assets/website/assets/img/bg/ed_and_skill_bg.png"
        style="background-image: url(&quot;assets/website/assets/img/bg/ed_and_skill_bg.png&quot;);">
        <div class="cs_slill_shape_1 position-absolute">
            <img src="/cache/assets/website/assets/img/skills_shape_1.svg" alt="skill and education ">
        </div>
                    ...
                    <div class="cs_education_wrap">
                        ...
                        <div class="cs_iconbox cs_style_3 cs_type_1 d-flex align-items-center">
                            <div class="cs_iconbox_icon cs_accent_color cs_filled_bg cs_center"
                                data-src="/cache/assets/website/assets/img/bg/iconbox_bg_3.svg"
