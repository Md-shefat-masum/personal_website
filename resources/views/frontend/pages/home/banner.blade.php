    ...
    <div class="cs_hero_box">
        ...
        <div class="cs_hero_box_in wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
            ...
            <p class="cs_hero_subtitle cs_font_24">
                ...
                <a href="/contact" class="cs_semi_bold cs_accent_color cs_text_btn">Let's Talk</a>
            </p>
        </div>
    </div>
    <div class="container cs_hero_info d-flex justify-content-between">
        <div class="cs_hero_left">
            <ul class="cs_mp_0">
                ...
                <li class="cs_hero_meta d-flex align-items-center">
                    <div>
                        ...
                        <a href="mailto:mshefat924@gmail.com" target="_blank" class="cs_white_color">
                ...
                <li class="cs_hero_meta d-flex align-items-center">
                    <div>
                        <div class="cs_dot cs_white_color cs_opacity_06">Whats App</div>
                        <a href="tel:+8801646376015" target="_blank" class="cs_white_color">
                            +8801646376015
                        </a>
                    </div>
                </li>
            ...
            <div class="cs_social_btns d-flex cs_gap_30">
                <a class="cs_accent_color_2" target="_blank" href="https://www.linkedin.com/in/md-shefat-ms512382/">
                    <i class="fab fa-linkedin fa-2x"></i>
                </a>
                <a class="cs_accent_color_2" target="_blank" href="https://www.youtube.com/@hungrycoder7541">
                    <i class="fab fa-youtube fa-2x"></i>
                </a>
                <a class="cs_accent_color_2" target="_blank" href="https://github.com/Md-shefat-masum">
