<!-- Start Hero Section -->
<section class="cs_hero cs_style_1 cs_filled_bg" style="background-image: url('/assets/website/assets/img/bg/hero_bg.svg')" data-src="/assets/website/assets/img/bg/hero_bg.svg">
